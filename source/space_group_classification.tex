...
\begin{screen}
  \begin{definition}[affine space-group type]
...
\begin{screen}
  \begin{definition}[space-group type]
...
\begin{screen}
  \begin{definition}[geometric crystal class]
...
\begin{screen}
  \begin{definition}[translation lattice]
...
\begin{screen}
  \begin{definition}[Bravais group]
...
\begin{screen}
  \begin{definition}[Bravais type of lattice]
...
\begin{screen}
  \begin{definition}[Bravais manifold]
...
\begin{screen}
  \begin{definition}[Bravais class]
...
\begin{screen}
  \begin{definition}[arithmetic crystal class]
...
\begin{screen}
  \begin{definition}[Bravais arithmetic crystal class]
...
\begin{screen}
  \begin{definition}[lattice system]
